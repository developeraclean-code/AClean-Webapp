...
function MatTrackView({ inventoryData, invUnitsData, setInvUnitsData, invTxData, matTrackFilter, setMatTrackFilter, matTrackSearch, setMatTrackSearch, matTrackDateFrom, setMatTrackDateFrom, matTrackDateTo, setMatTrackDateTo, setModalStok, supabase, fetchInventoryUnits, showNotif, currentUser }) {
  ...
  <div style={{ display: "grid", gap: 16 }}>
    ...
    {txFiltered.length === 0 ? (
      ...
      <div style={{ background: cs.card, border: "1px solid " + cs.border, borderRadius: 14, overflow: "hidden" }}>
        ...
        <div style={{ padding: "8px 16px", borderBottom: "1px solid " + cs.border, display: "grid", gridTemplateColumns: "1fr 1fr 100px 80px 100px", gap: 8, fontSize: 11, fontWeight: 700, color: cs.muted }}>
        ...
        {txFiltered.slice(0, 100).map((tx, i) => (
          <div key={tx.id || i}
            style={{ padding: "9px 16px", borderBottom: "1px solid " + cs.border + "55", display: "grid", gridTemplateColumns: "1fr 1fr 100px 80px 100px", gap: 8, background: i % 2 === 0 ? "transparent" : cs.surface, fontSize: 12 }}>
            <div>
            ...
            <div style={{ textAlign: "right", fontWeight: 700, color: tx.qty < 0 ? cs.red : cs.green }}>
